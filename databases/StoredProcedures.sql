...
create procedure sp_get_all_periods()
begin
...
-- 6 [GET] All education data
create procedure sp_get_all_education()
begin
    select
        id_period,
...
-- 7 [GET] All economy data
create procedure sp_get_all_economy()
begin
    select
        id_period,
        gini_index,
...
-- 8 [GET] All employment data
create procedure sp_get_all_employment()
begin
    select
        id_period,
        employed_population,
